...
/**
 * Created by wangchunlei on 16/1/12.
 */
public class DragDrawerLayout extends FrameLayout {
    final String TAG = "drag";
    /** View拖拽工具 */
    ...
    public DragDrawerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public DragDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        // 初始化参数
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.DragDrawerLayout);
            mHandleViewId = typedArray.getResourceId(R.styleable.DragDrawerLayout_handler, 0);
            mContentViewId = typedArray.getResourceId(R.styleable.DragDrawerLayout_content, 0);
            mHandleTop = typedArray.getDimensionPixelSize(R.styleable.DragDrawerLayout_handle_Top, mHandleTop);
            mHandleBottom = typedArray.getDimensionPixelSize(R.styleable.DragDrawerLayout_handle_Bottom, mHandleBottom);
        ...
        mDragHelper = ViewDragHelper.create(this, new ViewDragHelper.Callback() {
            ...
            public boolean tryCaptureView(View arg0, int arg1) {
                return mEnable && arg0 == mHandleView;
            }
